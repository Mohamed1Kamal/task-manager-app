...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TaskStates<T>);
}
...
/// @nodoc
class $TaskStatesCopyWith<T,$Res>  {
$TaskStatesCopyWith(TaskStates<T> _, $Res Function(TaskStates<T>) __);
}


/// Adds pattern-matching-related methods to [TaskStates].
extension TaskStatesPatterns<T> on TaskStates<T> {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String error)?  taskError,TResult Function()?  taskInit,TResult Function()?  taskLoading,TResult Function( List<TaskModel> data)?  taskSuccess,required TResult orElse(),}) {final _that = this;
switch (_that) {
case TaskError() when taskError != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String error)  taskError,required TResult Function()  taskInit,required TResult Function()  taskLoading,required TResult Function( List<TaskModel> data)  taskSuccess,}) {final _that = this;
switch (_that) {
case TaskError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String error)?  taskError,TResult? Function()?  taskInit,TResult? Function()?  taskLoading,TResult? Function( List<TaskModel> data)?  taskSuccess,}) {final _that = this;
switch (_that) {
case TaskError() when taskError != null:
return taskError(_that.error);case _TaskInit() when taskInit != null:
return taskInit();case TaskLoading() when taskLoading != null:
...
class TaskError<T> implements TaskStates<T> {
  const TaskError(this.error);
  

 final  String error;

/// Create a copy of TaskStates
...
@override
String toString() {
  return 'TaskStates<$T>.taskError(error: $error)';
}
...
/// @nodoc
abstract mixin class $TaskErrorCopyWith<T,$Res> implements $TaskStatesCopyWith<T, $Res> {
...
class _TaskInit<T> implements TaskStates<T> {
  const _TaskInit();
...
class TaskLoading<T> implements TaskStates<T> {
  const TaskLoading();
...
@override
String toString() {
  return 'TaskStates<$T>.taskLoading()';
}
...
class TaskSuccess<T> implements TaskStates<T> {
  const TaskSuccess(final  List<TaskModel> data): _data = data;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TaskSuccess<T>&&const DeepCollectionEquality().equals(other._data, _data));
}
...
@override
String toString() {
  return 'TaskStates<$T>.taskSuccess(data: $data)';
}
...
/// @nodoc
abstract mixin class $TaskSuccessCopyWith<T,$Res> implements $TaskStatesCopyWith<T, $Res> {
